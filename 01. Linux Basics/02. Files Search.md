...
find . -name my-file
```
We used the `-name` option, and searched for a file called my-file.

Keep in mind that the `-name` argument looks for case-sensitive terms in Linux. For case-insensitivity find command:
